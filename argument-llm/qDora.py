...
class TrainingArguments(transformers.TrainingArguments):
    ...
    max_steps: int = field(default=110, metadata={"help": 'How many optimizer update steps to take.'})
    ...
    dataloader_prefetch_factor: int = field(default=5, metadata={"help":'Number of batches to pre-fetch.'})
    dataloader_num_workers: int = field(default=2, metadata={"help": 'Number of processes allocated to data loading'})
